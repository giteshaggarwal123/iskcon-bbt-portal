  ...
  const fetchMeetings = async () => {
    try {
      ...
      const processedMeetings = (data || []).map(meeting => {
        ...
        if (Array.isArray(meeting.manual_attendees)) {
          manual_attendees = (meeting.manual_attendees as (string | { email: string; rsvp?: string | null })[]).map((a: string | { email: string; rsvp?: string | null }) => {
        ...
        const meeting_attendees = Array.isArray(meeting.meeting_attendees) ? meeting.meeting_attendees : [];
