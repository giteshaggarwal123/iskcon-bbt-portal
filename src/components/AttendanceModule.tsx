  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4">
      ...
      <Dialog open={showDetailsDialog} onOpenChange={setShowDetailsDialog}>
        <DialogContent className="max-w-xl min-w-[350px] w-full max-h-[70vh] flex flex-col">
          <DialogHeader>
            <DialogTitle>
          ...
          {detailsMeeting && (
            <>
              ...
              <div className="mb-4">
                ...
                {(() => {
                  ...
                  if (!meetingAtt || meetingAtt.attendees.length === 0) {
                    return <div className="text-muted-foreground">No attendees found.</div>;
                  }
                  return (
                    <table className="min-w-full text-sm">
                      <thead>
              ...
              {/* You can add RSVP summary here if you have RSVP data in detailsMeeting or related hooks */}
            </>
          )}
          <DialogClose asChild>
            <Button size="sm" variant="ghost" className="mt-4 ml-auto">Close</Button>
          </DialogClose>
        </DialogContent>
      </Dialog>
            ...
            <table className="min-w-full text-sm">
              ...
              <tbody>
                {selectedMember && meetings.map((meeting, i) => {
                  ...
                  return (
                    <tr key={i}>
                      <td className="px-4 py-2">{safeTitle(meeting.title)}</td>
                      <td className="px-4 py-2 text-center">{safeDate(meeting.start_time)}</td>
