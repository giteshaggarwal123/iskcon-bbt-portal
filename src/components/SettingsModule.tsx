      ...
      <div className="w-full max-w-7xl mx-auto p-4 lg:p-6 space-y-6">
        ...
        <Tabs defaultValue="personal" className="w-full space-y-6">
          <TabsList className="grid w-full grid-cols-3 h-auto p-1">
            <TabsTrigger value="personal" className="text-xs lg:text-sm py-2">Personal Info</TabsTrigger>
            <TabsTrigger value="notifications" className="text-xs lg:text-sm py-2">Notifications</TabsTrigger>
            <TabsTrigger value="integrations" className="text-xs lg:text-sm py-2">Integrations</TabsTrigger>
          </TabsList>
              ...
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-sm">
                  ...
                  {!canEditPersonalInfo && !canEditPhone && (
                    <div className="flex items-center space-x-2 mt-3 p-3 bg-amber-50 rounded-md">
              ...
              <CardContent className="pt-0 space-y-6">
                ...
                <div className="flex items-center justify-between py-2">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-500">Notifications when documents are updated</p>
                  </div>
                  <Switch
                    id="document-updates"
                ...
                <div className="flex items-center justify-between py-2">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-500">Alerts for new polls and voting deadlines</p>
                  </div>
                  <Switch
