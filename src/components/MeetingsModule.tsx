...
export const MeetingsModule: React.FC = () => {
  ...
  const useTemplate = (template: any) => {
    ...
    alert(`Creating meeting from template: ${template.name}`);
  };
                  ...
                  <CardContent>
                    ...
                    <div className="flex space-x-2">
                      ...
                      <Button 
                        variant="outline" 
                        size="sm"
                        onClick={() => handleMeetingSettings(meeting)}
                      >
                  ...
                  <CardContent>
                    ...
                    <div className="flex space-x-2">
                      <Button 
                        variant="outline" 
                        size="sm"
                        onClick={() => alert('Opening meeting minutes...')}
                      >
                        <FileText className="h-4 w-4 mr-2" />
                        View Minutes
                      </Button>
                      ...
                      <Button 
                        variant="outline" 
                        size="sm"
                        onClick={() => alert('Opening transcription...')}
                      >
